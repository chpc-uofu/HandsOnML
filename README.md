...
+ Install the miniforge base in a directory with variable name *DIR*<br>
...
+ Modify the `PATH` variable (assuming your `SHELL` is either `sh`, `bash` or `zsh`)<br>
  ...
  - `echo $(which python)`
+ Install the required packages (the file requirements.txt is to be found in <a href="./install/">install</a>)<br>
  `pip install -r install/requirements.txt`
+ A `miniforge` <a href="https://lmod.readthedocs.io/en/latest/">lmod</a> file can be found in the directory <a href="./install/lmod/">install/lmod/</a>.
